...
def statistics_a_star_start_position():
    ...
    with open("testresults.txt", "a") as file:
        ...
        file.write(f"A* start position:\nTotal number of tests: {number_tests}, #SUCCESS: {config.astar_start_position_number_success}, in percent: {config.elbow_start_position_number_success/(number_tests)}\n")
